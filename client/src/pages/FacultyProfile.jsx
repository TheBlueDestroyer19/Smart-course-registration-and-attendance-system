        ...
        <div className="glass-card animate-fade-in-up text-center rounded-3xl">
          ...
          {loading ? (
            ...
            <>
              ...
              <span className="mt-3 inline-block rounded-full bg-primary/15 border border-primary/30 px-4 py-1.5 text-xs font-bold text-primary">{profile.DESIGNATION}</span>
